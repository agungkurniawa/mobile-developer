...
void main() {
  ...
  print(nama.contains('Agung')); //keluarannya adalah true

  //untuk mengubah menjadi huruf kecil semua
  print(nama.toLowerCase()); //keluarannya adalah Agung kurniawan

  //untuk mengubah menjadi huruf besar semua
  print(nama.toUpperCase()); //keluarannya adalah Agung kurniawan

  //untuk memilih kata tertentu yang ingin ditampilkan dengan menggunakan index
  print(nama.substring(5)); //keluarannya adalah kurniawan Agung
  print(nama.substring(5, 9)); //keluarannya adalah kurniawan. Artinya mulai dari huruf index ke 5 (masuk) dan akhiri pada index ke 9 (tidak masuk) 
  ...
  /* Misalnya : */
  String name = ' Agung kurniawan ';
  print(name.trim()); //keluarannya = Agung kurniawan
  ...
  print(nama.endsWith('Agung')); //keluarannya adalah true
